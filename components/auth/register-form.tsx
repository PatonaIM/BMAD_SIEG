...
import { z } from "zod"
import { Box, Button, TextField, Typography, Alert, LinearProgress } from "@mui/material"
  ...
  return (
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ width: "100%", maxWidth: 400 }}>
      ...
      {password && (
        <Box sx={{ mt: 1, mb: 2 }}>
          ...
          <LinearProgress
            ...
            color={passwordStrength.color as "error" | "warning" | "info" | "success"}
          />
        </Box>
      )}
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mt: 2, textAlign: "center" }}>
        ...
        <Link href="/login" style={{ color: "#A16AE8", textDecoration: "none", fontWeight: 500 }}>
          Sign In
        </Link>
      </Typography>
    </Box>
