...
vi.mock("next/navigation", () => ({
  ...
  usePathname: () => "/interview/test-session-123",
}))
...
const renderWithProviders = (sessionId = "test-session-123") => {
  const queryClient = createTestQueryClient()

  // Mock useParams to return the sessionId
  vi.mocked(require("next/navigation").useParams).mockReturnValue({ sessionId })
...
describe("InterviewPage - Integration Tests", () => {
  beforeEach(() => {
    ...
    vi.mocked(fetch).mockResolvedValue({
      ...
      json: async () => ({
        ...
        ai_response: "Thank you for your response. Let me ask you another question...",
        question_number: 2,
        total_questions: 10,
      }),
    } as Response)
  ...
  describe("1.6-INT-FULL-001: Complete Send-Receive Workflow", () => {
